...
class Processor():
    ...
    def to_accelerate(self):
        self.data_loader['train'], self.data_loader['test'], self.model, self.optimizer = accelerator.prepare(
            self.data_loader['train'], self.data_loader['test'], self.model, self.optimizer
        )
